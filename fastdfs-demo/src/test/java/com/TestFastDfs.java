...
public class TestFastDfs {
    ...
    public void testUpload() {	//上传文件
        ...
        try { 
            ...
            //要上传的文件路径
            String local_filename = "C:/Users/zz/Desktop/tmp/1.txt";
...
//          String fileIds[] = storageClient.upload_file(local_filename, "png", nvp);
    ...
    public void testDownload() {	//下载文件
        ...
        try {
        	...
        	String filePath = "M00/00/00/BgYGEFx_YfSAIKcGAAAAA2BptL8404.txt";
            ClientGlobal.init(conf_filename);
            ...
            String storePath = "C:/Users/zz/Desktop/tmp/BgYGEFx_YfSAIKcGAAAAA2BptL8404.txt";
    ...
    public void testGetFileInfo(){ //获取文件信息
    	TrackerServer trackerServer =null;
    	StorageServer storageServer = null;
    //group1M00/00/00/BgYGEFx_YfSAIKcGAAAAA2BptL8404.txt
        try { 
        	String groupName = "group1";
        	String filePath = "M00/00/00/BgYGEFx_YfSAIKcGAAAAA2BptL8404.txt";
            ClientGlobal.init(conf_filename);
    ...
    public void testDelete(){ //删除文件
    	...
    	try { 
    		String groupName = "group1";
        	String filePath = "M00/00/00/BgYGD1x_O7iAMmilAAAACE00_xo836.txt";
    		ClientGlobal.init(conf_filename);
