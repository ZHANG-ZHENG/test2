...
public class FastDFSTest {
    ...
    public static void upload() throws Exception {
        ...
        String path = System.getProperty("user.dir") + File.separatorChar + "source" +  File.separatorChar + "1.txt";
    ...
    public static void download() throws Exception {
        // id:    group1/M00/00/00/wKgBr1crVnSAbI4sAAAeV2aU4jU126.jpg
        // url:    http://192.168.1.170/fastdfs/group1/M00/00/00/wKgBr1crVnSAbI4sAAAeV2aU4jU126.jpg
        String fileId = "group1/M00/00/00/BgYGB1x_kaiAau7ZAAAACZvsmn8204.txt";
        InputStream inputStream = FastDFSClientUtils.download("group1", fileId);
        byte[] bytes = null;
        bytes = new byte[inputStream.available()];
        inputStream.read(bytes);
        String str = new String(bytes);
        System.out.println("读取到文件 "+str);
//        System.out.println(inputStream.available());
//        String path = System.getProperty("user.dir") + File.separatorChar + "receive" +  File.separatorChar + "d1.txt";
