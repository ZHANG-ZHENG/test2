...
public class TestZookeeper implements Watcher{
  ...
  public static void main(String[] args) throws Exception {
     ...
     * 之后会话状态为 CONNECTED
     */
    ZooKeeper zookeeper1 = new ZooKeeper("192.168.102.133:2181", 5000, new TestZookeeper());
...
//    ZooKeeper zookeeper2 = new ZooKeeper("192.168.102.133", 5000, new TestZookeeper(),sessionId,sessionPasswd);
